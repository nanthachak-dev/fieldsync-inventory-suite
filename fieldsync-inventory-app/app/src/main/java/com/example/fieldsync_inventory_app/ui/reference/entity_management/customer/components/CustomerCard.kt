package com.example.fieldsync_inventory_app.ui.reference.entity_management.customer.components
    ...
    Card(
        ...
        Box(
            ...
            Row(
                ...
                Column {
                    Text(
                        text = (customer?.fullName ?: "Customer Name") + (" [id #${customer?.id ?: "0"}]"),
                        fontSize = 18.sp,
                    ...
                    Text(
                        text = "Type: ${customer?.customerTypeName ?: "N/A"}",
                        fontSize = 12.sp,
