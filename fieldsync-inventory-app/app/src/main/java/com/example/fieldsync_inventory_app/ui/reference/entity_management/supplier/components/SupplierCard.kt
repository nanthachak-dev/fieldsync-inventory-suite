package com.example.fieldsync_inventory_app.ui.reference.entity_management.supplier.components
    ...
    Card(
        ...
        Box(
            ...
            Row(
                ...
                Column {
                    Text(
                        text = (supplier?.fullName ?: "Supplier Name") + (" [id #${supplier?.id ?: "0"}]"),
                        fontSize = 18.sp,
                    ...
                    Text(
                        text = "Type: ${supplier?.supplierTypeName ?: "N/A"}",
                        fontSize = 12.sp,
