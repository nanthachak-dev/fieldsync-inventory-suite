...
class SyncStockMovementDetailsChangesUseCase @Inject constructor(
    private val repository: StockMovementDetailsRepository
) {
    suspend operator fun invoke(lastSyncTime: String) {
        repository.syncStockMovementDetailsChanges(lastSyncTime)
    }
}