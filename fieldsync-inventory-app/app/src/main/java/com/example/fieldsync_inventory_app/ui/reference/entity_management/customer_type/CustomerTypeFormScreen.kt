...
fun CustomerTypeFormScreen(
    ...
    val uiState by viewModel.customerTypeFormUiState.collectAsState()
    ...
    Scaffold(
        topBar = {
            SubTopBar(
                title = if (uiState.isEditing) "Update Customer Type [Id: #${viewModel.selectedCustomerType?.id}]" else "Add New Customer Type",
        ...
        LazyColumn(
            ...
            item {
                Button(
                    ...
                    Text(
                        text = if (uiState.isEditing) "Update Customer Type" else "Add New Customer Type",
                        color = Color.White,
                        fontSize = 18.sp,
...
// -- Preview --
private val previewViewModel = PreviewCustomerTypeFormViewModel()

@androidx.compose.ui.tooling.preview.Preview(showBackground = true)
@Composable
private fun PreviewCustomerTypeFormScreen() {
    CustomerTypeFormScreen(previewViewModel)
}