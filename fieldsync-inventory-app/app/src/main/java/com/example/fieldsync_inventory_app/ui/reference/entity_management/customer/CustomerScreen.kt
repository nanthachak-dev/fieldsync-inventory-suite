...
import com.example.fieldsync_inventory_app.ui.reference.entity_management.customer.components.CustomerCard
...
fun CustomerScreen(
    ...
    val customerUiState by viewModel.customerUiState.collectAsState()

    val isFirstLaunch by viewModel.isFirstLaunch.collectAsState()
    val customers = customerUiState.customers
    ...
    Scaffold(
        topBar = {
            SubTopBar("Customer", navController)
        },
            ...
            LazyColumn(
                ...
                items(filteredList, itemContent = {
                    CustomerCard(
                        it,
                        onCardClicked = {
                            viewModel.onEditCustomerItemClick(it)
                            navController?.navigate(Screen.CustomerForm.route)
                        },
                        onDeleteClicked = {
                            selectedCustomer = it
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        selectedCustomer?.let { viewModel.onDeleteCustomerItemClick(it) }
...
// -- Preview --
private val previewViewModel = PreviewCustomerViewModel()

@androidx.compose.ui.tooling.preview.Preview(showBackground = true)
@Composable
private fun PreviewCustomerScreen() {
    CustomerScreen(previewViewModel)
}