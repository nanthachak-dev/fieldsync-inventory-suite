package com.example.fieldsync_inventory_app.ui.main.stock_management.stock_out.seed_batch
...
import com.example.fieldsync_inventory_app.ui.main.stock_management.stock_out.IStockOutViewModel
import com.example.fieldsync_inventory_app.ui.main.stock_management.stock_out.PreviewStockOutViewModel
...
@Composable
fun AddSeedBatchStockOutScreen(
    ...
    val stockOutUiState by viewModel.stockOutUiState.collectAsState()
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // Price
            if (stockOutUiState.selectedTask == StockOutTask.SALE) {
                item {
                    Spacer(modifier = Modifier.height(16.dp))
                    TextInputWithSuffix(
                        label = "Price per Kg",
...
// -- Preview --
val previewAddSeedBatchViewModel = PreviewStockOutViewModel()

@Preview(showBackground = true)
@Composable
fun PreviewAddSeedBatchScreen() {
    RCRCSeedManagerTheme {
        AddSeedBatchStockOutScreen(previewAddSeedBatchViewModel)
    }
}
