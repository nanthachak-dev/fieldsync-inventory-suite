...
fun SupplierTypeFormScreen(
    ...
    val uiState by viewModel.supplierTypeFormUiState.collectAsState()
    ...
    Scaffold(
        topBar = {
            SubTopBar(
                title = if (uiState.isEditing) "Update Supplier Type [Id: #${viewModel.selectedSupplierType?.id}]" else "Add New Supplier Type",
        ...
        LazyColumn(
            ...
            item {
                Button(
                    ...
                    Text(
                        text = if (uiState.isEditing) "Update Supplier Type" else "Add New Supplier Type",
                        color = Color.White,
                        fontSize = 18.sp,
...
// -- Preview --
private val previewViewModel = PreviewSupplierTypeFormViewModel()

@androidx.compose.ui.tooling.preview.Preview(showBackground = true)
@Composable
private fun PreviewSupplierTypeFormScreen() {
    SupplierTypeFormScreen(previewViewModel)
}